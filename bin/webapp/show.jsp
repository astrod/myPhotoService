...
{	
	var commentListNumber = document.querySelectorAll('.commentlist'); // 모든 commentlist클래스를 배열로 받아온다.
	for(var i = 0 ; i<commentListNumber.length; i++) //배열의 길이만큼 돌리면
	{
		...
		var commentContainer = commentListNumber[i].querySelector('h3'); //그거를 h3로 옮겨
...
그림 : <img src=/images/${board.fileName} /> </br>
...
<input type="hidden" name="id" value="${board.id}">
	<textarea name="contents" rows="10" cols="50">댓글을 입력하세요</textarea></br>
